        ...
        <div className="bg-custom-gradient">
            <div className="bg-black bg-opacity-50 text-white min-h-screen">
                ...
                <div className="w-full md:w-[80vw] mx-auto py-20 px-5 md:px-0 font-medium text-lg">
                    ...
                    <br /><br />
                    The platform harnesses the power of sophisticated algorithms to deliver career advice that’s tailored just for you. From job matching and skill assessment to market trends and growth opportunities, we strive to equip you with everything you need to be informed for making decisions about your future.
                    <br /><br />
